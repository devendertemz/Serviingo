...
public class Privacypolicy extends BaseActivity implements View.OnClickListener {
    TextView tvprivacyPolicyy,Heading;
    ...
    private void setUi() {
        tvprivacyPolicyy=findViewById(R.id.tvprivacyPolicyy);
...
//Logout
    ...
    private void getPrivacyPolicy() {
        ...
        String url = AppUrls.getPrivacyPolicy;
        Log.v("faq_url", url);
    ...
    private void parseJsonResponse(JSONObject response) {
        try {
            ...
            if (response.getString("status").equals("true")) {
                ...
                JSONObject policy_contentobj=jsonObject.getJSONObject("policy_content");
                String policy_contentid=policy_contentobj.getString("id");
                String policy_contentimage=policy_contentobj.getString("image");
                String policy_contentheading=policy_contentobj.getString("heading");
                Heading.setText(" > "+policy_contentheading);
                String short_description=policy_contentobj.getString("short_description");
                String policy_contentdescription=policy_contentobj.getString("description");
                tvprivacyPolicyy.setText(Html.fromHtml(policy_contentdescription));
                String policy_contentcreated_at=policy_contentobj.getString("created_at");
                String policy_contentupdated_at=policy_contentobj.getString("updated_at");
